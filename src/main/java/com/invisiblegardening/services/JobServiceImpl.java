...
public class JobServiceImpl implements JobService{
    ...
    public void updateJob(Long id, Job job) {
        ...
        if (optionalJob.isPresent()) {
            ...
            var storedJob = optionalJob.get();
            storedJob.setId(storedJob.getId());
            storedJob.setJobName(job.getJobName());
            storedJob.setPicture(storedJob.getPicture());
            storedJob.setJobDescription(job.getJobDescription());
            storedJob.setEmployee(job.getEmployee());
            storedJob.setEmployeeNeeded(job.getEmployeeNeeded());
