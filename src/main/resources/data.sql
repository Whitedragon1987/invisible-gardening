...
insert into picture (id, data, name, type ) VALUES ( 1001, 37105, 'graven.jpg', 'image/jpeg');
insert into picture (id, data, name, type ) VALUES ( 1002, 37114, 'zwembad tuin.jpg', 'image/jpeg');
insert into picture (id, data, name, type ) VALUES ( 1003, 37106, 'kraan.jpg', 'image/jpeg');
insert into picture (id, data, name, type ) VALUES ( 1004, 37108, 'kraantje.jpg', 'image/jpeg');
insert into picture (id, data, name, type ) VALUES ( 1005, 37109, 'shovel.jpg', 'image/jpeg');
insert into picture (id, data, name, type ) VALUES ( 1006, 37113, 'trilplaat.jpg', 'image/jpeg');
insert into picture (id, data, name, type ) VALUES ( 1007, 37111, 'terrastegels.jpg', 'image/jpeg');
insert into picture (id, data, name, type ) VALUES ( 1008, 37110, 'snoeien.jpg', 'image/jpeg');
insert into picture (id, data, name, type ) VALUES ( 1009, 37115, 'tuinvoorbeeld.jpg', 'image/jpeg');
insert into picture (id, data, name, type ) VALUES ( 1010, 37116, '(speel)tuin.jpg', 'image/jpeg');
insert into picture (id, data, name, type ) VALUES ( 1011, 37117, 'moderne tuin.jpg', 'image/jpeg');
insert into picture (id, data, name, type ) VALUES ( 1012, 37118, 'schutting.jpg', 'image/jpeg');
